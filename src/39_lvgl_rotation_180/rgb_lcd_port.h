...
// Buffer count is determined by lvgl_port.h based on rotation/anti-tearing mode
#include "lvgl_port.h"
#define EXAMPLE_LCD_RGB_BUFFER_NUMS     LVGL_PORT_LCD_RGB_BUFFER_NUMS    ///< Number of frame buffers (2 or 3 depending on rotation)
